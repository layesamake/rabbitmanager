...
const resultOptions = [
  { label: 'Aucun changement observé', value: 'Aucun changement observé' },
  { label: 'Amélioration', value: 'Amélioration' },
  { label: 'À surveiller', value: 'À surveiller' },
  { label: 'Traitement terminé', value: 'Traitement terminé' },
  { label: 'À renouveler', value: 'À renouveler' },
  { label: 'Cas préoccupant', value: 'Cas préoccupant' },
];
...
const validationSchema = z.object({
  ...
  dateRealisation: z.string().regex(/^\d{4}-\d{2}-\d{2}$/, 'Date requise au format AAAA-MM-JJ'),
  ...
  resultatObserve: z.enum([
    'Aucun changement observé', 'Amélioration', 'À surveiller', 'Traitement terminé', 'À renouveler', 'Cas préoccupant'
  ]),
...
export default function EnregistrerTraitementFaitScreen() {
  ...
  const onSubmit = async (data: FormValues) => {
    try {
      ...
      await addTraitement({
        ...
        objectif: undefined,
        datePrevue: data.dateRealisation, // datePrevue = dateRealisation
        dateRealisation: data.dateRealisation,
        heure: data.heure?.trim() || undefined,
        ...
        statut: 'Fait',
        resultatObserve: data.resultatObserve,
    ...
    <SafeAreaView style={styles.safeArea}>
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.title}>Enregistrer traitement fait</Text>
        </View>
        ...
        <ScrollView contentContainerStyle={styles.form} showsVerticalScrollIndicator={false}>
          ...
          <Text style={styles.subtitle}>Traitement administré</Text>
          ...
          <Text style={styles.subtitle}>Informations de réalisation</Text>

          <FormInput
            name="dateRealisation"
            label="Date de réalisation"
            control={control}
            error={errors.dateRealisation}
          ...
          <FormInput
            name="heure"
            label="Heure de réalisation (optionnel)"
            control={control}
            error={errors.heure}
            placeholder="Ex: 09:30, Matin, Soir..."
            type="text"
          />
          ...
          <FormInput
            name="resultatObserve"
            label="Résultat observé"
            control={control}
            error={errors.resultatObserve}
            type="select"
          ...
          <View style={styles.buttonRow}>
            ...
            <TouchableOpacity style={styles.btnSubmit} onPress={handleSubmit(onSubmit)} activeOpacity={0.7}>
              <Text style={styles.btnSubmitText}>Enregistrer fait</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
      </View>
